# V3.2 - This is design Purely to send Flukso data to Pvoutput using MQTT.
...
# head over to https://forum.pvoutput.org/t/flukso-to-pvoutput-bypassing-the-flukso-server-script-discussion/7405 to discuss it.
